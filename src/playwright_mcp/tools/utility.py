...
class UtilityTools(BaseToolSet):
    ...
    async def _wait(self, args: Dict[str, Any]) -> ToolResult:
        ...
        try:
            if time_seconds:
                ...
                return ToolResult(
                    content=[TextContent(type="text", text=f"⏱️ Waited {time_seconds} seconds")]
                )
            elif selector:
                await tab.page.wait_for_selector(selector, timeout=timeout)
                return ToolResult(
                    content=[TextContent(type="text", text=f"✅ Element appeared: {selector}")]
                )
            elif text:
                ...
                return ToolResult(
                    content=[TextContent(type="text", text=f"✅ Text appeared: {text}")]
                )
            else:
                return ToolResult(
    ...
    async def _reload(self, args: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                content=[TextContent(type="text", text=f"🔄 Page reloaded: {title}")]
            )
        except Exception as e:
            return ToolResult(
    ...
    async def _scroll(self, args: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                content=[TextContent(type="text", text=f"📜 Scrolled {direction} by {amount}px")]
            )
        except Exception as e:
            return ToolResult(
    ...
    async def _evaluate(self, args: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                content=[TextContent(type="text", text=f"🔧 JavaScript result: {result}")]
            )
        except Exception as e:
            return ToolResult(
    ...
    async def _new_tab(self, args: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                content=[TextContent(type="text", text=f"🆕 New tab opened: {tab.tab_id}")]
            )
        except Exception as e:
            return ToolResult(
    ...
    async def _close_tab(self, args: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                content=[TextContent(type="text", text=f"❌ Tab closed: {tab_id}")]
            )
        except Exception as e:
            return ToolResult(
    ...
    async def _list_tabs(self, args: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            if not tabs:
                return ToolResult(
                    content=[TextContent(type="text", text="📋 No tabs open")]
                )
            ...
            return ToolResult(
                content=[TextContent(type="text", text=tabs_text)]
            )
        except Exception as e:
            return ToolResult(
    ...
    async def _switch_tab(self, args: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                content=[TextContent(type="text", text=f"🔄 Switched to tab: {tab_id}")]
            )
        except Exception as e:
            return ToolResult(
