...
class InteractionTools(BaseToolSet):
    ...
    async def _click(self, args: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                content=[TextContent(type="text", text=f"🖱️ Clicked on: {clicked_text}")]
            )
    ...
    async def _type(self, args: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                content=[TextContent(type="text", text=f"⌨️ Typed '{text}' into: {selector}")]
            )
        except Exception as e:
            return ToolResult(
    ...
    async def _fill(self, args: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                content=[TextContent(type="text", text=f"📝 Filled '{value}' into: {selector}")]
            )
        except Exception as e:
            return ToolResult(
    ...
    async def _select_option(self, args: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                content=[TextContent(type="text", text=f"📋 Selected '{value}' in: {selector}")]
            )
        except Exception as e:
            return ToolResult(
